...
<div class="row">
    ...
    <div class="col-lg-2 col-6">
        <x-adminlte-small-box title="{{ $userCount ?? 0 }}" text="Users" icon="fas fa-users" theme="info"/>
    </div>
    <div class="col-lg-2 col-6">
        <x-adminlte-small-box title="{{ $productCount ?? 0 }}" text="Products" icon="fas fa-box" theme="success"/>
    </div>
    <div class="col-lg-2 col-6">
        <x-adminlte-small-box title="{{ $orderCount ?? 0 }}" text="Orders" icon="fas fa-shopping-cart" theme="warning"/>
    </div>
    <div class="col-lg-3 col-6">
        <x-adminlte-small-box 
            title="Rp {{ number_format($totalRevenue ?? 0, 0, ',', '.') }}" 
            text="Total Revenue" 
            icon="fas fa-coins" 
            theme="primary"
        />
    ...
    <div class="col-lg-3 col-6">
        <x-adminlte-small-box 
            title="Rp {{ number_format($averageOrderValue ?? 0, 0, ',', '.') }}" 
...
<div class="row">
    <!-- Orders Chart -->
    <div class="col-md-6">
        <x-adminlte-card title="Orders per Month" theme="lightblue" body-class="p-3" body-style="height:300px;">
    ...
    <!-- Revenue Chart -->
    <div class="col-md-6">
        <x-adminlte-card title="Revenue per Month" theme="teal" body-class="p-3" body-style="height:300px;">
...
<div class="row">
    <!-- Users by Role -->
    <div class="col-md-6">
        <x-adminlte-card title="Users by Role" theme="indigo" body-class="p-3" body-style="height:300px;">
        ...
        <x-adminlte-card title="Top Customers" theme="success" body-class="p-0">
            <table class="table table-sm mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No customer data</td></tr>
                    @endforelse
                </tbody>
            </table>
        </x-adminlte-card>
